...
t.TryTick++;
if (null == e) XGame.Where(t.cbWhere, t.TryTick); else {
i.XNet.dispatchXNet("GX_WHERE_R", e);
t.WhereAfter();
}
},
WhereAfter: function() {
...
s.LoadFromFile("db/gm_cmd", this._onAfterGmConfig, this);
},
_onAfterGmConfig: function(t) {
var e = s.RowFeildValueFirstEx("ID", "10001", "NAME");
console.log("++++++++++++++" + e);
